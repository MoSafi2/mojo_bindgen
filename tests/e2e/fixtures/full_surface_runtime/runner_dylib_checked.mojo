from full_surface_runtime_bindings_dylib_checked import (
    surf_add,
    surf_affine,
    surf_apply_mode,
    surf_flags_score,
...
def main() raises:
    ...
    print("surf_apply_add|", surf_apply_mode(surf_mode(UInt32(1)), 9, 4))
    print("surf_apply_sub|", surf_apply_mode(surf_mode(UInt32(2)), 9, 4))
