...
from std.ffi import external_call, OwnedDLHandle, DEFAULT_RTLD, c_int
...
comptime gcr_mut = GlobalVar[T=c_int, link="gcr_mut"]
comptime gcr_limit = GlobalConst[T=c_int, link="gcr_limit"]
