...
#     f = au.tail_decls[0]
#     assert f.kind == FunctionKind.VARIADIC_STUB
...
#         MojoEmitOptions(),
#     )
#     analyzed_typedef = next(
#         d for d in au.tail_decls if not isinstance(d, AnalyzedFunction)
#     )
...
#     au = analyze_unit(
#         Unit(
#             source_header="t.h", library="t", link_name="t", decls=[parts, union_decl]
#         ),
#         MojoEmitOptions(),
#     )
...
#     i32 = _i32()
#     td = Typedef(
#         decl_id="typedef:my_size_t", name="my_size_t", aliased=i32, canonical=i32
#     )
...
#         decl_id=fp_typedef.decl_id, name="my_binary_op_t", canonical=fp
#     )
#     fn_direct = Function(
...
#         c_name="AtomicBox",
#         fields=[
#             Field(name="value", source_name="value", type=atomic_i32, byte_offset=0)
#         ],
#         size_bytes=4,
#         align_bytes=4,
#         is_union=False,
...
#         fields=[
#             Field(name="value", source_name="value", type=atomic_wchar, byte_offset=0)
#         ],
#         size_bytes=4,
#         align_bytes=4,
#         is_union=False,
...
#     assert any(
#         "atomic types were mapped" in note for note in au.semantic_fallback_notes
#     )
