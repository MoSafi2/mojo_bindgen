# Smoke test for dylib-checked bindings: dynamic load of libz and runtime FFI calls.
# Requires zlib_bindings_dylib_checked.mojo from generate.sh (--linking dylib-checked).
from zlib_bindings_dylib_checked import (
    Z_OK,
    compressBound,
    gzclose,
    gzgetc,
